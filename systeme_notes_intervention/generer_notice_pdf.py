        ...
        [
            ...
            section(
                ...
                [
                    ...
                    "Cliquer sur <b>Envoyer les notes</b>, vérifier les cases du tableau, modifier les mails signalés puis valider. L'option de marquage automatique ne coche <b>Transmis</b> qu'après un envoi réussi. Aucun mail n'est envoyé automatiquement.",
                    "Les cases <b>Transmis</b> et <b>Payé</b> restent aussi accessibles directement dans la liste des interventions.",
                    "Dans <b>Planning</b>, utiliser <b>Nouveau rappel</b> pour créer une échéance générale ou liée à un client. Elle peut être ponctuelle ou répétée par jour, semaine, mois ou année. Le même éditeur est disponible dans chaque fiche client.",
                ],
                styles,
            ),
            section(
