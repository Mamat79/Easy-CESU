...
1. Télécharger `EasyCESU-Setup-x64-3.1.2.exe` depuis la page des versions.
...
- `EasyCESU-macOS-Apple-Silicon-3.1.2.dmg` pour les Mac M1, M2, M3, M4 et suivants ;
- `EasyCESU-macOS-Intel-3.1.2.dmg` pour les anciens Mac Intel.
...
signale qu'elle provient d'un développeur non identifié. La version 3.1.2 n'est
